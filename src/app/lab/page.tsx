	...
	return (
		...
		>
            ...
            <div className="absolute inset-0 pointer-events-none isolate">
                <div className="absolute h-340 w-140 -translate-y-18 bg-[radial-gradient(80%_70%_at_50%_30%,hsl(288_100%_50%/.4),transparent_50%)] inset-[0_auto_auto_0] -rotate-45 z-1"></div>
            ...
            <div className="flex flex-1 h-full flex-col lg:flex-row gap-10 py-10 lg:pt-20">
                ...
                {/* iframe 컨테이너 */}
                <div className="relative w-full max-w-[1920px] max-h-[1080px] aspect-[5/3] bg-neutral-100 dark:bg-neutral-900 border rounded-xl border-app-fg/40 dark:border-none overflow-hidden">
                    {tabs.map((tab) =>
