  ...
  return (
	<>
		<div id="header-wrap" className="fixed w-full h-22.5 lg:h-30 px-5 md:px-7.5 lg:px-18 py-3 font-inst text-app-fg z-10">
			...
			<MenuButton className="block lg:hidden absolute right-5 md:right-7.5 top-6 sm:5.75 text-[16px] sm:text-xl font-medium z-30 cursor-pointer" />
			<header id="header" ref={headerRef} className="relative w-full h-full flex justify-center">
				<div id="inner-header" className="w-full max-w-465 flex items-start justify-between pt-2.5">
